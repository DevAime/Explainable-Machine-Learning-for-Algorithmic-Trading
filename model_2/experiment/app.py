...
def render_consent_screen():
    ...
    st.write(
        ...
        "5-minute intraday SPY (S&P 500 ETF) market scenarios. For each one, you'll see "
        "recent price movement and a signal generated by a model trained on 4 years of "
        "5-minute SPY trading data, then make your own decision about what you'd do."
    )
    st.write(
        "For some scenarios, you'll also see additional information about what "
        "influenced the model's signal; for others, you'll just see the signal itself. "
